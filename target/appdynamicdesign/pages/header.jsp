<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
	<%@ page import="com.fssa.dynamicdesign.model.*" %>
		...
		<body>
			...
			<header class="header">
				<div>
					<a href="#"> <img src="./assets/image/common/logo.png" alt="logo" class="logo" />
					</a>
				</div>
				<nav class="nav">

					<% String loggedInEmail=(String) session.getAttribute("loggedInEmail"); if (loggedInEmail==null) {
						%>
						<div id="button">
							<div class="dropdown">
								<button class="dropbtn">Login</button>
								<div class="dropdown-content">
									<a href="user_login.jsp">login as customer</a> <a href="architect_login.jsp">login
										as architect</a>
								</div>
							</div>
						...
						<% } else { User user=(User) session.getAttribute("user"); if (user==null) { %>
			...
			<a class="a" href="user_home.jsp">Home</a> <a class="a"
				...
				-->
								...
								<a class="a" href="user_home.jsp">Home</a> <a class="a"
									...
									href="./own_user_profile.jsp"> <img src="../assets/image/common/profile.png"
