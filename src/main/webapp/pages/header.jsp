	...
	<header class="header">
		...
		<nav class="nav">
			...
			<a class="a" href="architect_home.jsp">Home</a>
			 <a class="a" href="./architect_architect_list.html">Create Design</a>
            <a class="a" href="./architect_design_list.html">Designs</a>
            <a class="a" href="./own_architect_booking_list.html">Ordered list</a>
            <a class="a" href="./architect_about_us.html">About us</a>
            <a class="a" href="./architect_contact_us.html">Contact us</a>
            <a class="a" href="./own_architect_profile.html">
                <img src="../assets/image/common/profile.png" alt="profile" class="profileofuser">
            </a>
			...
			<a class="a" href="user_home.jsp">Home</a> <a class="a"
				href="userarchitectlistservlet">Architects</a> <a class="a"
				href="userdesignlistservlet">Designs</a> <a class="a"
				href="user_about_us.jsp">About us</a> <a class="a"
				href="user_contact_us.jsp">Contact us</a> <a class="a"
				href="./own_user_profile.jsp"> <img
