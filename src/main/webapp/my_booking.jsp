...
<body>
    ...
    <div id="a-form" class="design-form">
        <img class="designurl" id="designUrl" src="<%=booking.getDesignUrl()%>"  ait="interior design" />
        <div>
        ...
        <div class="both-btn">
			...
			%>
			  <img alt="interior design" class="free_img" Style="width: auto;height: auto;" src="./assets/image/common/mybooking.png">
			<%
			}
			%>
        </div>
