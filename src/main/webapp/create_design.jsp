				...
				<form action="createDesign" method="post" style=" width: 548px;font-size: 19px;" id="form2" id="onlyreg" class="onlyreg">
					<% String errorMessage=request.getParameter("error"); if (errorMessage !=null) { %>
						...
						<% } %>
							...
							<br /> <label>Style:</label> <input type="text" id="small" placeholder="style of the design"
								name="style" value="${style}" />
							<br /> <br /> <label> Square feet: *</label> <input type="number" id="small"
								placeholder="1213" min="10" max="99999" name="sqft" required value="${squarefeet}" />
							<br /> <br />
							<label>Price per
							...
							<br />
							<label>Required months:</label> <input type="number" id="small" placeholder="3"
								name="timerequired" value="${timerequired}" min="1" max="60" /> <br />
							<br /> <label>Bio about the design: *</label>
							<textarea type="text" pattern="{45,180}" name="bio" value="${bio}" required
									...
									<div class="card-body">
										<div id="dynamic-field-1" class="form-group dynamic-field">
											<label for="field" class="font-weight-bold">Image 1 *</label> <input
												type="text" id="small" class="form-control" required name="field[]" />
