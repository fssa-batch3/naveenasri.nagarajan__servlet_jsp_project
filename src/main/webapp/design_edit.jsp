...
<jsp:include page="architect_header.jsp"></jsp:include>
    ...
    <form action="DesignEditServlet" method="post" id="form2"
        ...
        <input type="number" name="designId" value="59" /><br /><br />
        ...
        <input type="text" id="designUrl" name="designUrl" value="https://cdn.pixabay.com/photo/2016/03/28/09/34/bedroom-1285156_1280.jpg" required /><br /><br />
        
        <label for="price">Price:</label>
        <input type="number" id="price" name="price" value="100.00" required /><br /><br />
        ...
        <input type="number" id="noOfRooms" name="noOfRooms" value="1" required /><br /><br />
